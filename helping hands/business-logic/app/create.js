...
*/
    const {requirement1, requirement2, category, adhaarNumber} = req.body;
...
*/
    //await database.client.collection(collections.LISTS).deleteMany();
    return await database.client.collection(collections.LISTS).insertOne(payload);
};